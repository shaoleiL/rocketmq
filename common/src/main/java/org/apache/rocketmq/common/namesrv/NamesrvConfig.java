...
public class NamesrvConfig {
    ...
    // 默认配置文件路径，不生效。nameServer启动时如果要通过配置文件配置NameServer启动属性的话，使用-c选项
    ...
    public String toString() {
        return "rocketmqHome = " + rocketmqHome + ", kvConfigPath = " + kvConfigPath + ", configStorePath = " + configStorePath;
    }
}
